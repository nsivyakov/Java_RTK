...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            ...
            try {
                ...
                // Второй вариант - через вызов функцию с уменьшением в product
                ...
                System.out.println("Функция вызвана - создан заказ id: " + orderidfunc);
                ...
                deleteTestRecords(conn, productId, customerId, orderId, orderidfunc);
                System.out.println("Удалены тестовые записи - " + "товар id=" + productId + ", клиент id=" + customerId + ", заказы id=" +
    ...
    private static void createSchema(Connection conn) throws SQLException {
        ...
        stmt.execute("COMMENT ON TABLE order_status IS 'Справочник статусов заказов';");
    ...
    private static void deleteTestRecords(Connection conn, int productId, int customerId, int orderId, int orderidfunc) throws SQLException {
        // Удаляем из order
        ...
        try (PreparedStatement pstmtorder = conn.prepareStatement(deleteorder);
             PreparedStatement pstmtorderfunc = conn.prepareStatement(deleteorderfunc);
